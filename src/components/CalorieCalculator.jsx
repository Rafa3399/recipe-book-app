...
function CalorieCalculator({ foodEaten, setFoodEaten }) {
  ...
  return (
    <div className="calorie-calculator-main">
      ...
      <h1>Daily Calories Calculator</h1>
        <div className='calculator'>
          <div className='calories-intake'>
            ...
            <label>
              Activity Level:
              <select id="last-select" value={activityLevel} onChange={handleActivityLevelChange}>
                <option value="">Select</option>
        ...
        <h3 id='result-text'>Total Calories Consumed: {totalCaloriesConsumed} cal</h3>
